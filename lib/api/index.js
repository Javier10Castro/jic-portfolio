...
const controllers = {
  ...
  architecture: require('./controllers/architectureController'),
  evolution: require('./controllers/evolutionController'),
  knowledge: require('./controllers/knowledgeController'),
};
