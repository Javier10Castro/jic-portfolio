...
const { registerKnowledgeRoutes } = require('./routes/knowledgeRoutes');
const { registerStudioRoutes } = require('./routes/studioRoutes');
...
function buildRouter() {
  ...
  registerKnowledgeRoutes(apiRouter, knowledgeController.getController());

  const studioController = require('./controllers/studioController');
  registerStudioRoutes(apiRouter, studioController.getController());
