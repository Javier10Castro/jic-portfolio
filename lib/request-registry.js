...
function registerLifecycle(requestId, updates) {
  ...
  const storeEntry = { ...entry, requestId, executionDurationMs: computed.executionDurationMs, queueWaitTimeMs: computed.queueWaitTimeMs, totalLifecycleTimeMs: computed.totalLifecycleTimeMs };
...
module.exports = { registerLifecycle, lookupRequest, getAggregateMetrics, listEntries, persistImmediate };
